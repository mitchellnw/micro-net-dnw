...
def train_loop(model_and_loss, optimizer, lr_scheduler, train_loader, val_loader, epochs, fp16, logger,
    ...
    if skip_training:
        ...
        model_profiling.model_profiling(model_and_loss.model, height=224, width=224)

    # Added -- saving initialization
    ...
    }, False, checkpoint_dir=checkpoint_dir, backup_filename='init.tar')
